...
<%@ include file="Header.jsp" %>
	...
	<div>
		...
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			%>
			<center>
						<h1 class=" font-weight-thin pt-3"><u>Subject
							List</u></h1>
					</center>
					</br>
				...
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						<tr>
							...
							<div class="input-group"><td align="center"><a href="SubjectCtl?id=<%=dto.getId()%>"><i class="fas fa-edit" grey-text" style="font-size: 1rem;">Edit</a></i></td>
						</tr>
					</tbody>
					<%
						}
