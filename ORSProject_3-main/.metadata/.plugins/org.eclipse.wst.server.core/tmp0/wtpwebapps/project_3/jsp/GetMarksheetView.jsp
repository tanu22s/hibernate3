...
<div>
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<table  width="100%" style="background-color: white;" border="3px">
				<tr >
					<th id="po1" style="background-color: white;" colspan="2">RollNo</th>
					<td id="po1" align="center" colspan="3"><%=DataUtility.getStringData(dto.getRollno())%></td>
				</tr>
				<tr>
					<th id="po1" colspan="2" style="background-color: white;">Name</th>
					<td id="po1" align="center" colspan="3"><%=DataUtility.getStringData(dto.getName())%></td>
				</tr>
				<tr style="background-color: #e1b5158c;">
					<th id="po1" style="background-color: white;" >Subject</th>
					<th id="po1"style="background-color: white;" align="center" >Max Marks</th>
					<th id="po1" style="background-color: white;" align="center">Min Marks</th>
					<th  id="po1" style="background-color: white;" align="center" colspan="2">Marks Obtain</th>
				</tr>
				<tr>
					<td colspan="3"></td>
					<th id="po1" style="background-color: white;" align="center">Marks</th>
					<th style="color: blue; background-color: white" id="po1" text-align="center" >Grade</th>
				</tr>
				<tr>
					<th id="po1"style="background-color: white;">Physics</th>
 ...
 %>
				...
				<tr>
					<th id="po1"style="background-color: white;">Chemistry</th>
					<td align="center">100</td>
					<td align="center">35</td>
 ...
 %>
				...
				<tr>
					<th id="po1"style="background-color: white;">Maths</th>
					<td align="center">100</td>
					<td align="center">35</td>
 ...
 %>
				...
				<tr>
					<th id="po1" colspan="2" style="background-color: white;">Total</th>
				...
				<tr>
					...
					<th id="po1" colspan="2" style="background-color: white;">Percentage</th>

					<td id="po1" align="center" colspan="3"><%=percentage%>%</td>
				</tr>
				<tr>
					<th id="po1" align="center" style="background-color: white;"colspan="2"><font color="blue">Grade:</font>
						<%
							if (percentage >= 90) {
						%> <b>A++</b> <%
