...
<%@ include file="Header.jsp" %>
	...
	<div>
		<form action="<%=ORSView.COURSE_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class=" font-weight-thin pt-3"><u>Course List</u></h1>
				<center>
					...
					<div style="margin-bottom: 20px;" class="table-responsive">
						<table class="table table-striped table-hover table-bordered">
							...
							<tbody>
								...
								<div class="input-group">	<td><a href="CourseCtl?id=<%=dto.getId()%>"><i class="fas fa-edit" grey-text" style="font-size: 1rem;">Edit</i></a></td></div>
								</tr>
							</tbody>
							<%
								}
